  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button 
          size="sm" 
          className="w-full justify-center rounded-xl bg-neutral-900 font-semibold text-neutral-50 shadow-lg transition-all duration-300 hover:bg-neutral-800"
        >
      ...
      <DialogContent className="fixed inset-0 m-auto !p-0 h-fit w-fit rounded-3xl bg-neutral-50 shadow-xl transition-all duration-300 dark:bg-neutral-900 sm:max-w-xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 p-6 pt-0">
          ...
          <Button 
            type="submit" 
            className="w-full rounded-xl bg-accent py-3 text-lg font-bold text-accent-foreground shadow-lg transition-all duration-300 hover:bg-accent/90"
          >
            Gửi thông tin
          </Button>
        </form>
